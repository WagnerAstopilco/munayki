<template>
  <div
    :class="['sidebar', { mobile: isMobile, hidden: !sidebarVisible }]"
    :style="{ left: sidebarVisible ? '0' : isMobile ? '-100%' : '0' }"
  >
    ...
    <router-link
      to="/admin/categorias"
      class="nav-link-custom"
      :class="{ active: active === 'categorias' }"
    >
    ...
    <router-link
      ...
      class="nav-link-custom"
      :class="{ active: active === 'actividades' }"
    >
    ...
    <router-link
      ...
      class="nav-link-custom"
      :class="{ active: active === 'promociones' }"
    >
